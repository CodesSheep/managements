...
public interface UserInfoService {
    ...
    List<UserInfo> getAllUserInfo(String empNo,String jurisdictionName,String teamNo,Integer offset, Integer limit);
    ...
    int getAllUserInfoCount(String empNo,String jurisdictionName,String teamNo);
