...
public class JedisCacheManager extends RedisCacheManager implements ApplicationContextAware, InitializingBean {
     ...
     * value serializer
     * <pre>
     *     直接new使用 FastJsonRedisSerializer 会报错：java.lang.ClassCastException
    ...
    public static final FastJsonRedisSerializer<Object> FASTJSON_SERIALIZER = fastJsonRedisSerializer();

    //配置存入redis的值的序列化方式
    public static FastJsonRedisSerializer<Object> fastJsonRedisSerializer() {
